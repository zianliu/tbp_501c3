...
\begin{document}
	...
	A active member may be declared ``temporarily inactive'' for the purposes of conducting official business by a four-sevenths vote of the Advisory Board. Such a ``temporarily inactive'' student is reactivated by a four-sevenths vote of the Advisory Board when the official business is completed. %The national bylaws doiesn't actually require that a majority of officers vote on this, so I'm taking that provision out.
	...
	\subsection{Subordinate Corporate Officers} %Defined to contrast from Chapter Officers
	...
	Temporary active status shall grant a member active status for the purposes of conducting official business, and shall be revoked should the member fail to establish active status by the conclusion of all three of the relevant chapter meetings for active membership. %Added to define temporary active.
	...
	The Chapter shall have such other committees as may from time to time be created through majority vote at an Advisory Board meeting, as detailed in Article 7, Section 10; and elected through officer elections, as detailed in Article 9. Such other committees may consist of persons who are not also members of the Advisory Board. %Changed to be consistent with 5.3 
	...
	Nominations for officers shall be made from the floor at the Election of Officers Meeting. Appropriate methods shall be established so that members participating remotely or in absentia may be nominated for an officer position. %suggested by Nate
	...
	%Added "officer meeting" for clarity
